...
class TeamArgs:
    ...
    def test_suite_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def test_suite_id(self, value: pulumi.Input[_builtins.str]):
...
class _TeamState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] team_id: The GraphQL ID of the team.
        :param pulumi.Input[_builtins.str] test_suite_id: The GraphQL ID of the test suite.
        :param pulumi.Input[_builtins.str] uuid: The UUID of the test suite-team relationship.
        """
...
@pulumi.type_token("buildkite:TestSuite/team:Team")
class Team(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="testSuiteId")
    def test_suite_id(self) -> pulumi.Output[_builtins.str]:
        """
        The GraphQL ID of the test suite.
        """
        return pulumi.get(self, "test_suite_id")
