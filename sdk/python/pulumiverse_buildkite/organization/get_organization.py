...
class GetOrganizationResult:
    ...
    def allowed_api_ip_addresses(self) -> Sequence[_builtins.str]:
        """
...
def get_organization_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrganizationResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('buildkite:Organization/getOrganization:getOrganization', __args__, opts=opts, typ=GetOrganizationResult)
    return __ret__.apply(lambda __response__: GetOrganizationResult(
        allowed_api_ip_addresses=pulumi.get(__response__, 'allowed_api_ip_addresses'),
