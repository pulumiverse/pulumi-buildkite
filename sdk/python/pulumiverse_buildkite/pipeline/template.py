...
class TemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the pipeline template.
        """
...
class _TemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description for the pipeline template.
        :param pulumi.Input[_builtins.str] name: The name of the pipeline template.
        :param pulumi.Input[_builtins.str] uuid: The UUID of the pipeline template.
        """
        if available is not None:
            pulumi.set(__self__, "available", available)
...
@pulumi.type_token("buildkite:Pipeline/template:Template")
