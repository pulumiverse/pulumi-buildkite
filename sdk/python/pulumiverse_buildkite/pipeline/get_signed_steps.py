...
class GetSignedStepsResult:
    ...
    def jwks_key_id(self) -> Optional[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def steps(self) -> _builtins.str:
        return pulumi.get(self, "steps")

    @_builtins.property
    @pulumi.getter(name="unsignedSteps")
    def unsigned_steps(self) -> _builtins.str:
        """
...
def get_signed_steps(jwks: Optional[_builtins.str] = None,
                     jwks_file: Optional[_builtins.str] = None,
                     jwks_key_id: Optional[_builtins.str] = None,
                     repository: Optional[_builtins.str] = None,
                     unsigned_steps: Optional[_builtins.str] = None,
    ...
    :param _builtins.str jwks: The JSON Web Key Set (JWKS) to use for signing.
           All double-quotes in the JSON object must be escaped `\\"`.
           If `jwks_key_id` is not specified, and the set contains exactly one key, that key will
           be used.
    :param _builtins.str repository: The repository that will be checked out in a build of the pipeline.
    :param _builtins.str unsigned_steps: The steps to sign in YAML format.
    """
    __args__ = dict()
    __args__['jwks'] = jwks
...
def get_signed_steps_output(jwks: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('buildkite:Pipeline/getSignedSteps:getSignedSteps', __args__, opts=opts, typ=GetSignedStepsResult)
    return __ret__.apply(lambda __response__: GetSignedStepsResult(
        id=pulumi.get(__response__, 'id'),
        jwks=pulumi.get(__response__, 'jwks'),
        jwks_file=pulumi.get(__response__, 'jwks_file'),
        jwks_key_id=pulumi.get(__response__, 'jwks_key_id'),
        repository=pulumi.get(__response__, 'repository'),
        steps=pulumi.get(__response__, 'steps'),
        unsigned_steps=pulumi.get(__response__, 'unsigned_steps')))
