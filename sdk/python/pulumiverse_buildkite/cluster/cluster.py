...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] emoji: An emoji to use with the Cluster, this can either be set using :buildkite: notation, or with the
               emoji itself, such as 🚀.
        :param pulumi.Input[_builtins.str] name: The name of the Cluster. Can only contain numbers and letters, no spaces or special characters.
        """
...
@pulumi.type_token("buildkite:Cluster/cluster:Cluster")
