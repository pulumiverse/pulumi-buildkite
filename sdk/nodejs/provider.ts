...
export class Provider extends pulumi.ProviderResource {
     ...
     */
    declare public readonly graphqlUrl: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly restUrl: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["archivePipelineOnDelete"] = pulumi.output(args?.archivePipelineOnDelete).apply(JSON.stringify);
            resourceInputs["graphqlUrl"] = args?.graphqlUrl;
            resourceInputs["maxRetries"] = pulumi.output(args?.maxRetries).apply(JSON.stringify);
            resourceInputs["organization"] = args?.organization;
            resourceInputs["restUrl"] = args?.restUrl;
            resourceInputs["timeouts"] = pulumi.output(args?.timeouts).apply(JSON.stringify);
        }
    ...
    terraformConfig(): pulumi.Output<Provider.TerraformConfigResult> {
        return pulumi.runtime.call("pulumi:providers:buildkite/terraformConfig", {
            "__self__": this,
        }, this);
    }
}
