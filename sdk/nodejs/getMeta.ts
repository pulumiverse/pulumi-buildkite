 ...
 * ```
 */
export function getMetaOutput(opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMetaResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("buildkite:index/getMeta:getMeta", {
    }, opts);
}
