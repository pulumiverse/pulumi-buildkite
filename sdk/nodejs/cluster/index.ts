...
export const ClusterMaintainer: typeof import("./clusterMaintainer").ClusterMaintainer = null as any;
...
export const ClusterSecret: typeof import("./clusterSecret").ClusterSecret = null as any;
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "buildkite:Cluster/clusterMaintainer:ClusterMaintainer":
                return new ClusterMaintainer(name, <any>undefined, { urn })
