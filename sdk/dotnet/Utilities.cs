...
namespace Pulumiverse.Buildkite
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumiverse/pulumi-buildkite";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Buildkite.version.txt");
    ...
    internal sealed class BuildkiteResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public BuildkiteResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
