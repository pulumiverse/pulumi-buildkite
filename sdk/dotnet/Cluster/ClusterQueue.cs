...
namespace Pulumiverse.Buildkite.Cluster
{
    ...
    public partial class ClusterQueue : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("dispatchPaused")]
        public Output<bool> DispatchPaused { get; private set; } = null!;

        /// <summary>
        /// Control the settings for the Buildkite hosted agents.
        /// </summary>
        [Output("hostedAgents")]
        public Output<Outputs.ClusterQueueHostedAgents?> HostedAgents { get; private set; } = null!;
        ...
        /// </summary>
        [Output("retryAgentAffinity")]
        public Output<string> RetryAgentAffinity { get; private set; } = null!;
    ...
    public sealed class ClusterQueueArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<bool>? DispatchPaused { get; set; }

        /// <summary>
        /// Control the settings for the Buildkite hosted agents.
        /// </summary>
        [Input("hostedAgents")]
        public Input<Inputs.ClusterQueueHostedAgentsArgs>? HostedAgents { get; set; }
        ...
        /// Specifies which agent should be preferred when a job is retried. Valid values are `prefer-warmest` (prefer agents that have recently finished jobs) and `prefer-different` (prefer a different agent if available). Defaults to `prefer-warmest`.
        /// </summary>
        [Input("retryAgentAffinity")]
        public Input<string>? RetryAgentAffinity { get; set; }
    ...
    public sealed class ClusterQueueState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("hostedAgents")]
        public Input<Inputs.ClusterQueueHostedAgentsGetArgs>? HostedAgents { get; set; }
