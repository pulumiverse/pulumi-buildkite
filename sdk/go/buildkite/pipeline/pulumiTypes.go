...
type PipelineProviderSettings struct {
	...
	CancelWhenMergeGroupDestroyed *bool `pulumi:"cancelWhenMergeGroupDestroyed"`
...
type PipelineProviderSettingsArgs struct {
	...
	// Whether to cancel any running builds belonging to a removed merge group.
	CancelWhenMergeGroupDestroyed pulumi.BoolPtrInput `pulumi:"cancelWhenMergeGroupDestroyed"`
	// The condition to evaluate when deciding if a build should run. This is only valid when `triggerMode` is `code`. More details available in [the documentation](https://buildkite.com/docs/pipelines/conditionals).
...
// Whether to cancel any running builds belonging to a removed merge group.
func (o PipelineProviderSettingsOutput) CancelWhenMergeGroupDestroyed() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v PipelineProviderSettings) *bool { return v.CancelWhenMergeGroupDestroyed }).(pulumi.BoolPtrOutput)
}
...
// When enabled, agents performing a git diff to determine steps to upload based on [`ifChanged`](https://buildkite.com/docs/pipelines/configure/step-types/command-step#agent-applied-attributes)comparisons will use the base commit that points to the previous merge group rather than the base branch
func (o PipelineProviderSettingsOutput) UseMergeGroupBaseCommitForGitDiffBase() pulumi.BoolPtrOutput {
...
// Whether to create merge queue builds for a merge queue enabled GitHub repository with required status checks
func (o PipelineProviderSettingsPtrOutput) BuildMergeGroupChecksRequested() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PipelineProviderSettings) *bool {
		if v == nil {
			return nil
		}
...
// Whether to create builds for pull requests when its base branch changes.
func (o PipelineProviderSettingsPtrOutput) BuildPullRequestBaseBranchChanged() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PipelineProviderSettings) *bool {
		if v == nil {
			return nil
		}
...
// Whether to cancel any running builds belonging to a removed merge group.
func (o PipelineProviderSettingsPtrOutput) CancelWhenMergeGroupDestroyed() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PipelineProviderSettings) *bool {
		if v == nil {
			return nil
		}
...
// Whether to prevent caching pull requests with the source branch matching the default branch.
func (o PipelineProviderSettingsPtrOutput) IgnoreDefaultBranchPullRequests() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PipelineProviderSettings) *bool {
		if v == nil {
			return nil
		}
...
// When enabled, agents performing a git diff to determine steps to upload based on [`ifChanged`](https://buildkite.com/docs/pipelines/configure/step-types/command-step#agent-applied-attributes)comparisons will use the base commit that points to the previous merge group rather than the base branch
func (o PipelineProviderSettingsPtrOutput) UseMergeGroupBaseCommitForGitDiffBase() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *PipelineProviderSettings) *bool {
		if v == nil {
			return nil
		}
