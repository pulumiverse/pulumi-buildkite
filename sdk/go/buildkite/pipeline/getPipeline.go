...
// The GraphQL ID of the cluster the pipeline is (optionally) attached to.
func (o LookupPipelineResultOutput) ClusterId() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPipelineResult) string { return v.ClusterId }).(pulumi.StringOutput)
}

// The name of the cluster the pipeline is (optionally) attached to.
func (o LookupPipelineResultOutput) ClusterName() pulumi.StringOutput {
	return o.ApplyT(func(v LookupPipelineResult) string { return v.ClusterName }).(pulumi.StringOutput)
}
