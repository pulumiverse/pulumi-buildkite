...
type Pipeline struct {
	...
	// The YAML steps to configure for the pipeline. Can also accept the `steps` attribute from the [`Pipeline.getSignedSteps`](https://www.terraform.io/docs/data-sources/signed_pipeline_steps) data source to enable a signed pipeline. Defaults to `buildkite-agent pipeline upload`.
...
// The name of the cluster the pipeline is (optionally) attached to.
func (o PipelineOutput) ClusterName() pulumi.StringOutput {
	return o.ApplyT(func(v *Pipeline) pulumi.StringOutput { return v.ClusterName }).(pulumi.StringOutput)
}
