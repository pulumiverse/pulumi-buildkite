...
type LookupClusterResult struct {
	...
	Maintainers []GetClusterMaintainerType `pulumi:"maintainers"`
	// The name of the cluster to retrieve.
	Name string `pulumi:"name"`
...
// List of maintainers (users and teams) for this cluster.
func (o LookupClusterResultOutput) Maintainers() GetClusterMaintainerTypeArrayOutput {
	return o.ApplyT(func(v LookupClusterResult) []GetClusterMaintainerType { return v.Maintainers }).(GetClusterMaintainerTypeArrayOutput)
}
