...
// The Key for the cluster queue; its unique identifier
func (o ClusterDefaultQueueOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v *ClusterDefaultQueue) pulumi.StringOutput { return v.Key }).(pulumi.StringOutput)
}
