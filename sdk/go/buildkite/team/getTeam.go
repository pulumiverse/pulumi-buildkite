...
// Whether members can create registries.
func (o LookupTeamResultOutput) MembersCanCreateRegistries() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupTeamResult) bool { return v.MembersCanCreateRegistries }).(pulumi.BoolOutput)
}

// Whether members can create test suites.
func (o LookupTeamResultOutput) MembersCanCreateSuites() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupTeamResult) bool { return v.MembersCanCreateSuites }).(pulumi.BoolOutput)
}

// Whether members can destroy packages.
func (o LookupTeamResultOutput) MembersCanDestroyPackages() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupTeamResult) bool { return v.MembersCanDestroyPackages }).(pulumi.BoolOutput)
}

// Whether members can destroy registries.
func (o LookupTeamResultOutput) MembersCanDestroyRegistries() pulumi.BoolOutput {
	return o.ApplyT(func(v LookupTeamResult) bool { return v.MembersCanDestroyRegistries }).(pulumi.BoolOutput)
}
