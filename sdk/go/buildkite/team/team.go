...
type Team struct {
	...
	MembersCanCreateRegistries pulumi.BoolOutput `pulumi:"membersCanCreateRegistries"`
	// Whether members of the team can create test suites.
	MembersCanCreateSuites pulumi.BoolOutput `pulumi:"membersCanCreateSuites"`
	// Whether members of the team can destroy packages.
	MembersCanDestroyPackages pulumi.BoolOutput `pulumi:"membersCanDestroyPackages"`
	// Whether members of the team can destroy registries.
	MembersCanDestroyRegistries pulumi.BoolOutput `pulumi:"membersCanDestroyRegistries"`
...
type TeamState struct {
	...
	// Whether members of the team can create registries.
	MembersCanCreateRegistries pulumi.BoolPtrInput
	// Whether members of the team can create test suites.
	MembersCanCreateSuites pulumi.BoolPtrInput
	// Whether members of the team can destroy packages.
	MembersCanDestroyPackages pulumi.BoolPtrInput
	// Whether members of the team can destroy registries.
	MembersCanDestroyRegistries pulumi.BoolPtrInput
	// The name of the team.
...
// Whether members of the team can create registries.
func (o TeamOutput) MembersCanCreateRegistries() pulumi.BoolOutput {
	return o.ApplyT(func(v *Team) pulumi.BoolOutput { return v.MembersCanCreateRegistries }).(pulumi.BoolOutput)
}

// Whether members of the team can create test suites.
func (o TeamOutput) MembersCanCreateSuites() pulumi.BoolOutput {
	return o.ApplyT(func(v *Team) pulumi.BoolOutput { return v.MembersCanCreateSuites }).(pulumi.BoolOutput)
}

// Whether members of the team can destroy packages.
func (o TeamOutput) MembersCanDestroyPackages() pulumi.BoolOutput {
	return o.ApplyT(func(v *Team) pulumi.BoolOutput { return v.MembersCanDestroyPackages }).(pulumi.BoolOutput)
}

// Whether members of the team can destroy registries.
func (o TeamOutput) MembersCanDestroyRegistries() pulumi.BoolOutput {
	return o.ApplyT(func(v *Team) pulumi.BoolOutput { return v.MembersCanDestroyRegistries }).(pulumi.BoolOutput)
}
