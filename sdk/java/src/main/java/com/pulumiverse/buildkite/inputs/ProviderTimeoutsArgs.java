...
package com.pulumiverse.buildkite.inputs;
...
public final class ProviderTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProviderTimeoutsArgs Empty = new ProviderTimeoutsArgs();
    ...
    private ProviderTimeoutsArgs() {}

    private ProviderTimeoutsArgs(ProviderTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.read = $.read;
        this.update = $.update;
    ...
    public static Builder builder(ProviderTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProviderTimeoutsArgs();
        }

        public Builder(ProviderTimeoutsArgs defaults) {
            $ = new ProviderTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProviderTimeoutsArgs build() {
            return $;
        }
    }
