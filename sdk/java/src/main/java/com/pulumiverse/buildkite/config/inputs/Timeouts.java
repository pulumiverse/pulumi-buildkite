...
package com.pulumiverse.buildkite.config.inputs;
...
public final class Timeouts {
    ...
    public static Builder builder(Timeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(Timeouts defaults) {
        ...
        public Timeouts build() {
            final var _resultValue = new Timeouts();
