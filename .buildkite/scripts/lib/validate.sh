...
# Assert that the desired Buildkite plugin binary exists in
# '${PULUMI_HOME}/plugins'.
function validate_plugin {
    ...
    installed_version="$("${PULUMI_HOME}/plugins/resource-buildkite-${_version}/pulumi-resource-buildkite" -version)"
